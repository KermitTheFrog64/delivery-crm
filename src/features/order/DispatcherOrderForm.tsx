...
interface DispatcherOrderFormProps {
    initialValues: Order
    onSubmit: (values: Order) => void
}

const DispatcherOrderForm: React.FC<DispatcherOrderFormProps> = ({ initialValues, onSubmit }) => {
...
export default DispatcherOrderForm